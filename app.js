...
// 🌟 FIX: PROTECT SAVED GRID FROM ACCIDENTAL "PROCESS" CLICKS
...
window.syncFromCloud = async function() {
    ...
    try {
        ...
        window.rawSavedGrid = cloudData.savedGrid || []; // 🌟 Catch Saved Grid

        window.runCalculationEngine(true, false); // false = use saved grid if exists
...
// 🌟 NEW: SAVE EDITED GRID TO CLOUD (MasterGrid Tab)
window.saveGridToCloud = async function() {
    ...
    try {
        ...
        if(resultText.includes("Success")) {
            ...
            window.rawSavedGrid = [...generatedWeeklyTimetable]; // Update local memory
...
// ... [renderExamSchedule & exportPDF remain same as before] ...
